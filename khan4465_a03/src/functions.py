...
def footage_to_acres(square_feet):
    ...
    ------------------------------------------------------
    """
    acres = float(square_feet/ONEACRE)
    return acres
...
def multiply_fractions(num1, den1, num2, den2):
    ...
    num_product =  int(num1 * num2)
    den_product = int(den1 * den2)
    
    division = float(num_product/den_product)
    
    return num_product,den_product,division
...
def falling_distance(falling_time):
    ...
    distance = float((falling_time**2)*GRAVITY/2)
    return distance