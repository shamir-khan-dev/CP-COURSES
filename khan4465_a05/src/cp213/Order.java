...
public class Order implements Printable {
    ...
    public BigDecimal getSubTotal() {
        ...
        for (Map.Entry<MenuItem, Integer> entry : this.items.entrySet()) {
            BigDecimal price = entry.getKey().getTariff();
    ...
    public String toString() {
        ...
        for (Map.Entry<MenuItem, Integer> entry : this.items.entrySet()) {
            ...
            BigDecimal price = item.getTariff();
            BigDecimal total = price.multiply(new BigDecimal(qty));
            sb.append(String.format(lineFormat, item.getName(), qty, price, total));
        }
        sb.append("\n");
        sb.append(String.format(totalFormat, "Subtotal:", this.getSubTotal()));
        sb.append(String.format(totalFormat, "Taxes:", this.getTaxes()));
        sb.append(String.format(totalFormat, "Total:", this.getTotal()));
        return sb.toString();
    }
